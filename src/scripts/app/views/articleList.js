    ...
    let ArticleListView = BB.View.extend({
            ...
            app.on(
                ...
                function () {
                    if (
                        ...
                        this.selectedItems[0].model.get("unread") === true
                    ) {
        ...
        addItem: function (item) {
            ...
            if (!after) {
                ...
                const indexElement =
                    after.view instanceof ItemView ? after : after.nextElementSibling;
        ...
        addItems: function (items, multiple = false) {
            ...
            const renderBlock = (renderId, startingPoint = 0) => {
                ...
                window.requestIdleCallback(
                    renderBlock.bind(this, renderId, startingPoint + internalCounter)
                );
            };
